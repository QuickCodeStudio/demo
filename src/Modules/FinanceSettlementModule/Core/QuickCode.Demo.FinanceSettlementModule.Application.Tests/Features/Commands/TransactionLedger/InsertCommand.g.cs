...
namespace QuickCode.Demo.FinanceSettlementModule.Application.Tests.Features.TransactionLedger
{
    public class InsertTransactionLedgerCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertTransactionLedgerCommand.InsertTransactionLedgerHandler>> _loggerMock;
        public InsertTransactionLedgerCommandTests()
        {
            _repositoryMock = new Mock<ITransactionLedgerRepository>();
            _loggerMock = new Mock<ILogger<InsertTransactionLedgerCommand.InsertTransactionLedgerHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertTransactionLedgerCommand.InsertTransactionLedgerHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertTransactionLedgerCommand(fakeDto);
            // Act
