...
namespace QuickCode.Demo.IdentityModule.Persistence.Tests.Repositories
{
    public class ApiKeyRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<ApiKeyRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public ApiKeyRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<ApiKeyRepository>>();
        }

        private ApiKeyRepository CreateRepository()
        {
            return new ApiKeyRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
