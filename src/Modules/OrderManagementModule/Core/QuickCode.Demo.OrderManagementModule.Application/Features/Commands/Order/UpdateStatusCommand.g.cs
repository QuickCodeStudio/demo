...
namespace QuickCode.Demo.OrderManagementModule.Application.Features.Order
{
    public class UpdateStatusCommand : IRequest<Response<int>>
    {
        ...
        public UpdateStatusCommand(int orderId, UpdateStatusRequestDto updateRequest)
        {
        ...
        public class UpdateStatusHandler : IRequestHandler<UpdateStatusCommand, Response<int>>
        {
            ...
            public UpdateStatusHandler(ILogger<UpdateStatusHandler> logger, IOrderRepository repository)
            {
                _logger = logger;
            ...
            {
                var returnValue = await _repository.UpdateStatusAsync(request.OrderId, request.UpdateRequest);
