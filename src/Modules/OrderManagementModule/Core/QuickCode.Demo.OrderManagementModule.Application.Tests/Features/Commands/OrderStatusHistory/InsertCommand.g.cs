...
namespace QuickCode.Demo.OrderManagementModule.Application.Tests.Features.OrderStatusHistory
{
    public class InsertOrderStatusHistoryCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertOrderStatusHistoryCommand.InsertOrderStatusHistoryHandler>> _loggerMock;
        public InsertOrderStatusHistoryCommandTests()
        {
            _repositoryMock = new Mock<IOrderStatusHistoryRepository>();
            _loggerMock = new Mock<ILogger<InsertOrderStatusHistoryCommand.InsertOrderStatusHistoryHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertOrderStatusHistoryCommand.InsertOrderStatusHistoryHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertOrderStatusHistoryCommand(fakeDto);
            // Act
