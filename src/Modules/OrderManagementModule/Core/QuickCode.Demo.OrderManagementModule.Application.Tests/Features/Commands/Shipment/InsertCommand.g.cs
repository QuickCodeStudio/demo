...
namespace QuickCode.Demo.OrderManagementModule.Application.Tests.Features.Shipment
{
    public class InsertShipmentCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertShipmentCommand.InsertShipmentHandler>> _loggerMock;
        public InsertShipmentCommandTests()
        {
            _repositoryMock = new Mock<IShipmentRepository>();
            _loggerMock = new Mock<ILogger<InsertShipmentCommand.InsertShipmentHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertShipmentCommand.InsertShipmentHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertShipmentCommand(fakeDto);
            // Act
