...
namespace QuickCode.Demo.OrderManagementModule.Application.Tests.Features.ReturnRequest
{
    public class InsertReturnRequestCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertReturnRequestCommand.InsertReturnRequestHandler>> _loggerMock;
        public InsertReturnRequestCommandTests()
        {
            _repositoryMock = new Mock<IReturnRequestRepository>();
            _loggerMock = new Mock<ILogger<InsertReturnRequestCommand.InsertReturnRequestHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertReturnRequestCommand.InsertReturnRequestHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertReturnRequestCommand(fakeDto);
            // Act
