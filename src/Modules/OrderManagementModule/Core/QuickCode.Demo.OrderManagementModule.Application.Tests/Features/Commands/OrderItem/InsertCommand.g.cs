...
namespace QuickCode.Demo.OrderManagementModule.Application.Tests.Features.OrderItem
{
    public class InsertOrderItemCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertOrderItemCommand.InsertOrderItemHandler>> _loggerMock;
        public InsertOrderItemCommandTests()
        {
            _repositoryMock = new Mock<IOrderItemRepository>();
            _loggerMock = new Mock<ILogger<InsertOrderItemCommand.InsertOrderItemHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertOrderItemCommand.InsertOrderItemHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertOrderItemCommand(fakeDto);
            // Act
