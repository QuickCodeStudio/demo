...
namespace QuickCode.Demo.PricingEngineModule.Application.Tests.Features.CampaignApplicability
{
    public class InsertCampaignApplicabilityCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertCampaignApplicabilityCommand.InsertCampaignApplicabilityHandler>> _loggerMock;
        public InsertCampaignApplicabilityCommandTests()
        {
            _repositoryMock = new Mock<ICampaignApplicabilityRepository>();
            _loggerMock = new Mock<ILogger<InsertCampaignApplicabilityCommand.InsertCampaignApplicabilityHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertCampaignApplicabilityCommand.InsertCampaignApplicabilityHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertCampaignApplicabilityCommand(fakeDto);
            // Act
