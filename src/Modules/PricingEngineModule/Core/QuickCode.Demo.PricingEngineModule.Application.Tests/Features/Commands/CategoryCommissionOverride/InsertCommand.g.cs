...
namespace QuickCode.Demo.PricingEngineModule.Application.Tests.Features.CategoryCommissionOverride
{
    public class InsertCategoryCommissionOverrideCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertCategoryCommissionOverrideCommand.InsertCategoryCommissionOverrideHandler>> _loggerMock;
        public InsertCategoryCommissionOverrideCommandTests()
        {
            _repositoryMock = new Mock<ICategoryCommissionOverrideRepository>();
            _loggerMock = new Mock<ILogger<InsertCategoryCommissionOverrideCommand.InsertCategoryCommissionOverrideHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertCategoryCommissionOverrideCommand.InsertCategoryCommissionOverrideHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertCategoryCommissionOverrideCommand(fakeDto);
            // Act
