...
namespace QuickCode.Demo.PricingEngineModule.Application.Tests.Features.PromotionalCampaign
{
    public class InsertPromotionalCampaignCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertPromotionalCampaignCommand.InsertPromotionalCampaignHandler>> _loggerMock;
        public InsertPromotionalCampaignCommandTests()
        {
            _repositoryMock = new Mock<IPromotionalCampaignRepository>();
            _loggerMock = new Mock<ILogger<InsertPromotionalCampaignCommand.InsertPromotionalCampaignHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertPromotionalCampaignCommand.InsertPromotionalCampaignHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertPromotionalCampaignCommand(fakeDto);
            // Act
