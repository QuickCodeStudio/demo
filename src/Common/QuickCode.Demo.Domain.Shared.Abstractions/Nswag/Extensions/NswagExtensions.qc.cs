...
using QuickCode.Demo.Domain.Shared.Abstractions.Helpers;

namespace QuickCode.Demo.Domain.Shared.Abstractions.Nswag.Extensions
{
    public static class NswagExtensions
    {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            ...
            string namespacePrefix = "QuickCode.Demo.Domain.Shared.Abstractions.Nswag.Clients.")
        {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            Assembly assembly, bool addRetryHandler=false, string namespacePrefix = "QuickCode.Demo.Domain.Shared.Abstractions.Nswag.Clients.")
        {
