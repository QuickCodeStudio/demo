...
namespace QuickCode.Demo.Portal.Helpers
{
    public static class ExtensionLibrary
    {
        ...
        /// <summary>
        /// Portal grid/report display: ISO-8601 calendar date + 24h time (invariant, sortable).
        /// Sentinel / unset values render as empty.
        /// </summary>
        public static string ToPortalGridDateTime(this DateTime value)
        {
            if (value.Year <= 1)
            {
                return string.Empty;
        ...
        public static string ToPortalGridDateTime(this DateTime? value)
            => value.HasValue ? value.Value.ToPortalGridDateTime() : string.Empty;

        public static string ToPortalGridDateTime(this DateTimeOffset value)
        {
            if (value.Year <= 1)
            {
                return string.Empty;
        ...
        /// <summary>
        /// Date-only portal grid display (yyyy-MM-dd).
        /// </summary>
        public static string ToPortalGridDate(this DateTime value)
        {
            if (value.Year <= 1)
            {
                return string.Empty;
        ...
        public static string ToPortalGridDate(this DateTime? value)
            => value.HasValue ? value.Value.ToPortalGridDate() : string.Empty;

        /// <summary>
        /// Formats unknown boxed datetime values for portal grids (query DTOs, etc.).
        /// </summary>
        public static string ToPortalGridDateTime(this object value)
        {
            ...
            return value switch
            {
                DateTime dt => dt.ToPortalGridDateTime(),
                DateTimeOffset dto => dto.ToPortalGridDateTime(),
                _ => DateTime.TryParse(value.ToString(), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out var parsed)
                     || DateTime.TryParse(value.ToString(), CultureInfo.CurrentCulture, DateTimeStyles.None, out parsed)
                    ? parsed.ToPortalGridDateTime()
                    : value.ToString() ?? string.Empty
            };
        }

        public static string ToPortalGridDate(this object value)
        {
            if (value == null || value == DBNull.Value)
            {
                return string.Empty;
            ...
            return value switch
            {
                DateTime dt => dt.ToPortalGridDate(),
                DateTimeOffset dto => dto.DateTime.ToPortalGridDate(),
                _ => DateTime.TryParse(value.ToString(), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out var parsed)
                     || DateTime.TryParse(value.ToString(), CultureInfo.CurrentCulture, DateTimeStyles.None, out parsed)
                    ? parsed.ToPortalGridDate()
                    : value.ToString() ?? string.Empty
            };
        }

        /// <summary>
        /// Money/amount grid display: invariant thousands + 2 decimals (1,234.56).
        /// </summary>
        public static string ToPortalGridMoney(this object value)
        {
            if (!TryPortalGridDecimal(value, out var number))
            {
        ...
        /// <summary>
        /// Integer grid display: invariant thousands grouping (1,234).
        /// </summary>
        public static string ToPortalGridInt(this object value)
        {
            if (!TryPortalGridDecimal(value, out var number))
            {
                return value == null || value == DBNull.Value ? string.Empty : value.ToString() ?? string.Empty;
            ...
            return decimal.Truncate(number).ToString("N0", CultureInfo.InvariantCulture);
        }

        /// <summary>
        /// High-precision decimal grid display (coordinates / rates): up to 8 places, trim zeros.
        /// </summary>
        public static string ToPortalGridDecimal(this object value)
        {
            if (!TryPortalGridDecimal(value, out var number))
            {
                return value == null || value == DBNull.Value ? string.Empty : value.ToString() ?? string.Empty;
        ...
        /// <summary>
        /// Percent grid display: 12.50%
        /// </summary>
        public static string ToPortalGridPercent(this object value)
        {
            if (!TryPortalGridDecimal(value, out var number))
            {
                return value == null || value == DBNull.Value ? string.Empty : value.ToString() ?? string.Empty;
        ...
        private static bool TryPortalGridDecimal(object value, out decimal number)
        {
            number = 0m;
            if (value == null || value == DBNull.Value)
            {
            ...
            text = text.TrimEnd('%', ' ');
            return decimal.TryParse(text, NumberStyles.Number | NumberStyles.AllowLeadingSign, CultureInfo.InvariantCulture, out number)
                   || decimal.TryParse(text, NumberStyles.Number | NumberStyles.AllowLeadingSign, CultureInfo.CurrentCulture, out number);
        }
